      ...
      <div className="lg:mx-auto lg:max-w-7xl  py-24">
        ...
        >
          {products.map((product) => (
            <li
              key={product.title}
              className="relative flex bg-theme-white flex-col rounded-xl shadow-lg overflow-hidden p-8 border border-theme-navy"
            >
