...
const getTokenListByChain = (
  ...
  if (chainId === POLYGON.chainId)
    return [...indexNamesPolygon, ...portfolioNamesPolygon]
  if (chainId === ARBITRUM.chainId)
    return [...indexNamesArbitrum, ...portfolioNamesArbitrum]
  if (chainId === OPTIMISM.chainId)
    return [...indexNamesOptimism, ...portfolioNamesOptimism]
  return [...indexNamesMainnet, ...portfolioNamesMainnet]
}
