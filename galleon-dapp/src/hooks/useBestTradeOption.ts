...
export const useBestTradeOption = () => {
  ...
  const fetchAndCompareOptions = async (
    ...
    const { duration } = await captureDurationAsync(async () => {
      ...
      let dexSwapError: any = null
      let setTokenAmount: any = null
      let dexSwapOption: ZeroExData | null = null
      ...
      if (!eiOnly) {
        ...
        setTokenAmount = getSetTokenAmount(
          isIssuance,
          sellTokenAmount,
          sellToken.decimals,
          sellTokenPrice,
      ...
      if (tokenEligibleForLeveragedEI) {
        ...
        if (isEligibleTradePair)
          try {
            ...
            // TODO: 
            console.log(sellToken, buyToken, setTokenAmount)
      ...
      if (eiOnly) {
        const result: Result<ZeroExData, Error> = {
          ...
          leveragedExchangeIssuanceData: null,
        }
