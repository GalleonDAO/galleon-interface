...
function getApiUrl(query: string, chainId: number): string {
  ...
  // example: https://api.0x.org/swap/v1/quote?sellToken=ETH&buyToken=0x1494CA1F11D487c2bBe4543E90080AeBa4BA3C2b&sellAmount=10000000000000000000
  return `https://${networkKey}${API_0X_URL}${quotePath}?${query}`;
}
