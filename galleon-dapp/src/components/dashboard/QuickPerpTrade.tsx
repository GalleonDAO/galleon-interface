...
const QuickPerpTrade = (props: {
  ...
  const [perpExchangeIssuanceData, setPerpExchangeIssuanceData] = useState(null)
  const {
  ...
  const sellTokenAmountInWei = toWei(setTokenAmount, props.singleToken.decimals)
  ...
  } = useApproval(props.singleToken, spenderAddressPerpEI, sellTokenAmountInWei)
